...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int):
        Double = ((sagenes * 3 + arshins) * 16 + vershoks) * 4.445 / 100.0
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg + (min + sec / 60.0) / 60.0) / 180.0 * PI
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int):
        Int = (60 * hoursArrive + minutesArrive) - (60 * hoursDepart + minutesDepart)
