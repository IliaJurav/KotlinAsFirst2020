...
class Tests {
    ...
    fun flattenPhoneNumber() {
        ...
        assertEquals("", flattenPhoneNumber("+ +7134-874"))
        assertEquals("", flattenPhoneNumber("+(17)1(34)-874"))
        assertEquals("", flattenPhoneNumber("(+27)134-874"))
    }
    ...
    fun fromRoman() {
        ...
        assertEquals(486, fromRoman("CDLXXXVI"))
